      ...
      '<div class="form-inline">',
        '<div class="sb-date-select">',
          '<div class="form-group" style="margin-left:0;margin-right:15px;">',
            '<select class="sb-date-select-day form-control" ng-model="val.date", ng-options="d for d in dates">',
              '<option value disabled selected>Day</option>',
            '</select>',
          '</div>',
          '<div class="form-group" style="margin-left:0;margin-right:15px;">',
            '<select class="sb-date-select-month form-control" ng-model="val.month", ng-options="m.value as m.name for m in months">',
              '<option value disabled>Month</option>',
            '</select>',
          '</div>',
          '<div class="form-group" style="margin-left:0;margin-right:15px;">',
            '<select class="sb-date-select-year form-control" ng-model="val.year" ng-options="y for y in years">',
