(function() {
	...
	function Model(config) {
		...
		cart.employeeId = 0; /* TODO whg this should be factored out somewhere else*/
		cart.ownerId = 1;
		...
		cart.regSettings = {
			...
			eventStatement: 'Select an event.',
			termsText: '',
			refundsText: '',
			//stripeLogoPath: '',
			stripeCheckoutButtonText: '',
			stripeOrderDescription: '',
			addonStatement: 'Select any desired addons.',
		...
		cart.configureSettings = function(data) {
			...
			cart.regSettings.eventStatement = data.eventStatement;
			...
			cart.regSettings.addonStatement = data.addonStatement;
