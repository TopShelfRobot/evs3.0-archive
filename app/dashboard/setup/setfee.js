(function() {
    ...
    angular.module('app').controller(controllerId, ['$q', '$routeParams', '$upload', '$http', '$timeout', '$location', '$scope', 'common', 'datacontext', 'config', setfee]);

    function setfee($q, $routeParams, $upload, $http, $timeout, $location, $scope, common, datacontext, config) {
