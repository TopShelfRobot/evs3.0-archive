(function () {
    ...
    angular.module('app').controller(controllerId, ['$routeParams', '$scope', 'config', 'common', 'datacontext', 'ExcelService', sendemail]);

    function sendemail($routeParams, $scope, config, common, datacontext, excel) {
