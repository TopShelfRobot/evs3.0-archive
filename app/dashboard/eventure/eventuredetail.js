(function () {
	...
	angular.module('app').controller(controllerId, ['$routeParams', 'common', 'datacontext', 'config', 'Cloner', eventuredetail]);

	function eventuredetail($routeParams, common, datacontext, config, cloner) {
