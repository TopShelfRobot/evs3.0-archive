(function () {
	...
	function Controller($rootScope, $location, $timeout, common, cart, config, authService) {
		var self = this;
		...
		//Dynamic CSS owner settings do not return in time to set this....
	...
	angular.module('app').controller(controllerId, ['$rootScope', '$location', '$timeout', 'common', 'CartModel', 'config', 'authService', Controller]);
})();
